    ...
    public class ProductMapper
    {
        ...
        public static List<Product> getAllProducts()
        {
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                tempProd.RetailPrice = System.Convert.ToInt32(dr["product_price"]);
                prods.Add(tempProd);
            }//end forEach
            return prods;
        }
        ...
        public static Product getProductById(Product p)
        {
            ...
            p.ImageFile = ds.Tables[0].Rows[0]["product_ImageName"].ToString();
            p.Size = ds.Tables[0].Rows[0]["product_size"].ToString();
            p.Colour = ds.Tables[0].Rows[0]["product_colour"].ToString();
            p.Status = ds.Tables[0].Rows[0]["product_status"].ToString();
            p.Notes = ds.Tables[0].Rows[0]["product_notes"].ToString();
            return p;
        }
