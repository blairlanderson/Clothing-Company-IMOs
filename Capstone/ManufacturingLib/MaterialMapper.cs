...
using IMOsData; //housing for local db + dataAccess class
    ...
    public class MaterialMapper
    {
        ...
        public static List<Material> getAllMaterials()
        {
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                tempMat.Description = dr["material_description"].ToString();
                tempMat.Cost = System.Convert.ToDecimal(dr["material_cost"]);
